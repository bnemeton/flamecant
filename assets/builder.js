class Builder {
    ...
    fillRegion(region, x, y, z) {
        ...
        console.log(tilesFilled + ' tiles filled as region ' + region)
        return tilesFilled;
    }
        ...
        for (var x = 0; x < this._width; x++) {
            for (var y = 0; y < this._height; y++) {
                if (this._regions[z][x][y] == region) {
                    ...
                    this._regions[z][x][y] = 0;
                    this._tiles[z][x][y] = new WallTile();
                }
            }
        }
    }
    ...
    findRegionOverlaps(z, r1, r2) {
        ...
        for (var x = 0; x < this._width; x++) {
            for (var y = 0; y < this._height; y++) {
                if (this._tiles[z][x][y] instanceof FloorTile &&
                    this._tiles[z+1][x][y] instanceof FloorTile &&
    ...
    connectRegions(z, r1, r2) {
        ...
        var point = overlap[0];
        this._tiles[z][point.x][point.y] = new StairDown();
        this._tiles[z+1][point.x][point.y] = new StairUp();
        return true;
    }
            ...
            for (var x = 0; x < this._width; x++) {
                for (var y = 0; y < this._height; y++) {
                    ...
                    if (this._tiles[z][x][y] instanceof FloorTile &&
                        ...
                        this.connectRegions(z, this._regions[z][x][y],
                            this._regions[z+1][x][y]);
                        connected[key] = true;
                    }
                }
